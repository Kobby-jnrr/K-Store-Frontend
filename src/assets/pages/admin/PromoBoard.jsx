...
function PromoBoard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const durations = {};
        activeIds.forEach(
          (id) => (durations[id] = promoRes.data.durationWeeks || 2)
        );
  ...
  return (
    <div className="promo-board-page">
      ...
      <p>
        Activate or remove promo banners for vendors with duration 1–4 weeks.
      </p>
                  ...
                  <tr key={vendor._id}>
                    ...
                    <td>
                      <select
                        ...
                        onChange={(e) =>
                          handleDurationChange(vendor._id, +e.target.value)
                        }
                        disabled={isActive}
                      >
                        {[1, 2, 3, 4].map((week) => (
